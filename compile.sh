...
# Setup test env
coffee -j "${DEST_DIR}/scripts/background.js" -c "${SRC_DIR}/tests/background/" "${SRC_DIR}/scripts/background/" "${UTIL}"

coffee -j "${DEST_DIR}/tests/views.tests.js" -c "${SRC_DIR}/tests/views/" "${SRC_DIR}/scripts/views/" "${UTIL}"
